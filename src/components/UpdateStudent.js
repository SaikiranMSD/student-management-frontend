...
const UpdateStudent = () => {
  ...
  const UpdateStudent = (e) => {
    ...
    if (validateForm()) {
      ...
      const updatedStudentData = { ...student, studentId };
      StudentService.updateStudentData(updatedStudentData)
        .then((response) => {
        ...
        .catch((error) => {
          if (error.response && error.response.data) {
            ...
            setErrorMessage(error.response.data.message); // Set the error message in the state variable
          } else {
            console.log(error);
    ...
    if (studentId) {
      StudentService.getStudentById(studentId)
        .then((response) => {
          ...
          setStudentAge(response.data.studentAge);
          setStudentEmail(response.data.studentEmail);
          setStudentAddress(response.data.studentAddress);
          setStudentPhoneNumber(response.data.studentPhoneNumber);
          setFirstCourseName(response.data.firstCourseName);
          setSecondCourseName(response.data.secondCourseName);
        })
        .catch((err) => {
          console.log(err);
        });
